...
CREATE TABLE IF NOT EXISTS `mydb`.`Genre` (
  `idGenre` INT NOT NULL,
  `nameTheme` VARCHAR(1000) NOT NULL,
  PRIMARY KEY (`idGenre`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Language` (
  ...
  `nameLanguage` VARCHAR(1000) NOT NULL,
  `nativeName` VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`LanguageGame` (
  `idGame` INT NOT NULL,
  `idLanguage` INT NOT NULL,
  `idLanguageSupportType` INT NOT NULL,
  PRIMARY KEY (`idGame`, `idLanguage`, `idLanguageSupportType`),
  INDEX `fk_Game_has_Language_Language1_idx` (`idLanguage` ASC) VISIBLE,
  INDEX `fk_Game_has_Language_Game1_idx` (`idGame` ASC) VISIBLE,
  INDEX `fk_LanguageGame_LanguageSupportType1_idx` (`idLanguageSupportType` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Game_has_Language_Language1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_LanguageGame_LanguageSupportType1`
    FOREIGN KEY (`idLanguageSupportType`)
    REFERENCES `mydb`.`LanguageSupportType` (`idLanguageSupportType`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`LanguageSupportType`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`LanguageSupportType` ;

CREATE TABLE IF NOT EXISTS `mydb`.`LanguageSupportType` (
  `idLanguageSupportType` INT NOT NULL,
  `name` VARCHAR(300) NULL,
  PRIMARY KEY (`idLanguageSupportType`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Mode` (
  `idMode` INT NOT NULL,
  `nameMode` VARCHAR(1000) NOT NULL,
  PRIMARY KEY (`idMode`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Platform` (
  ...
  `namePlatform` VARCHAR(1000) NULL,
  `manufacturer` VARCHAR(1000) NULL,
  `releaseDate` DATE NULL,
  `onlineFeatures` VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PlayerPerspective` (
  `idPlayerPerspective` INT NOT NULL,
  `namePlayerPersective` VARCHAR(1000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Region` (
  `idRegion` INT NOT NULL,
  `nameRegion` VARCHAR(1000) NOT NULL,
